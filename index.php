...
<head>
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Portfolio - Tanmay Teckchandani</title>
                     ...
                     <a href="#modal-01" title="">
                        ...
                        <div class="overlay">
                           <div class="portfolio-item-meta">
          					      <h5>Resume Designer (Mobile App)</h5>
                              <p>Intern @ Collabera, INDIA</p>
          					   </div>
                        </div>
                ...
                <div class="columns portfolio-item">
                  <div class="item-wrap">
                     ...
                     <a href="#modal-02" title="">
                        ...
                        <div class="overlay">
                           <div class="portfolio-item-meta">
          					      <h5>All about league of legends</h5>
  ...
  <div class="w3-row">
    ...
    <div class="w3-third">
      ...
      <img src="/images/IMG_6668.JPG" style="width:150%;padding:10px;" onclick="onClick(this)" alt="Graphic Designing">
        ...
        <img src="/images/IMG_6669.JPG" style="width:100%;padding:10px;" onclick="onClick(this)" alt="UI Design Weather App">
    ...
    <div class="w3-modal-content w3-animate-zoom w3-center w3-transparent w3-padding-64">
      ...
      <p id="caption"></p>
         ...
         <div id="modal-01" class="popup-modal mfp-hide">
		      ...
		      <img class="scale-with-grid" src="images/portfolio/modals/resume.jpg" alt="" />
         ...
         <div id="modal-02" class="popup-modal mfp-hide">
		      ...
		      <div class="description-box">
			      ...
			      <p>The Website shows the Description and information about the Game - The League of Legends.</p>
               <span class="categories"><i class="fa fa-tag"></i>Web Development, gaming</span>
		      </div>
